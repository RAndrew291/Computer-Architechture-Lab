...
TickAgain
    ...
    AND  R4 , R0, #0x0000FFFF  ; Store the tens digit in R4
    ...
    OR  R6 , R6, R12  ; combine both digits into R6's least significant byte 
...
decrement ; [from Fragment 2 solution]
